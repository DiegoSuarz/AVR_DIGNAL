...
#define PR_LCD_D6	PORTD	//define MCU pin connected to LCD D5
#define DR_LCD_D6	DDRD	//define MCU pin connected to LCD D5	

#define PR_LCD_D7	PORTD	//define MCU pin connected to LCD D6
#define DR_LCD_D7	DDRD	//define MCU pin connected to LCD D6
...
void LCDstring(const uint8_t*, uint8_t);			//Envia una String al LCD - Outputs string to LCD
